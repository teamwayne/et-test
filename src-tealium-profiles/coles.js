 ...
 * /sgio/,
 */
window.load.config.eTrack.whitelistBrands = [/coles/];
...
/** List of elements where if no click priority attributes found, track clicks on these elements.
 * @param {array string} clickTrackingDefaultElements
 */
window.load.config.eTrack.clickTrackingDefaultElements = [
  'a',
  'li',
  'button',
  'span',
